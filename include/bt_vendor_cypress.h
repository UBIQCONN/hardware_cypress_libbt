...
/******************************************************************************
 *
 *  Filename:      bt_vendor_cypress.h
 *
 *  Description:   A wrapper header file of bt_vendor_lib.h
 *
 *                 Contains definitions specific for interfacing with Cypress
 *                 Bluetooth chipsets
 *
 ******************************************************************************/

#ifndef BT_VENDOR_CYPRESS_H
#define BT_VENDOR_CYPRESS_H
...
/* USERIAL_SET_DEF_BAUD_BEFORE_CLOSING_PORT
   Set uart baudrate to default before closing port
*/
#ifndef USERIAL_SET_DEF_BAUD_BEFORE_CLOSING_PORT
#define USERIAL_SET_DEF_BAUD_BEFORE_CLOSING_PORT        FALSE
#endif
